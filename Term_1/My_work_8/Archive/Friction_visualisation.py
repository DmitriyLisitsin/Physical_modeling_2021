...
#%%
w = np.round(np.sqrt(w0**2 - (b/2)**2), 4)
print('Частота: ', w)
...
#%%
w_exp1 = np.round(2*np.pi * of.count_frequency(T, V), 4)
print('Эксп.частота 1: ', w_exp1)

Q_exp = np.round(of.count_q_factor(T, V, X), 4)
...
Xt = of.friction_oscillation(T, w0, b, x0, v0)
