...
F = Data[:, 5]
E = Data[:, 6]
x10, x20, v10, v20, m1, m2, L1, L2 = np.loadtxt(folder + name, max_rows=1)

#%%
fig, [[ax1, ax2], [ax3, ax4]] = plt.subplots(2, 2)
ax1.plot(T, X1, label='первый')
ax1.plot(T, X2, label='второй')
ax1.legend(loc='lower right', fontsize=12)
ax1.set_title('x from t', fontsize = 12)

ax2.plot(T, V1, label='первый')
ax2.plot(T, V2, label='второй')
...
ax4.plot(X1, V1, label='первый')
ax4.plot(X2, V2, label='второй')
